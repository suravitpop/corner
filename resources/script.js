...
function doCallAjax(Search) {
    ...
    HttPRequest.onreadystatechange = function() {
        if (HttPRequest.readyState == 3) {
            document.getElementById("search").innerHTML = "<img src='../images/ajax-loader.gif'/></div>";
        }
...
function ajaxcalllivechannel(offset, livegroup) {
    var url = "action-livechannel.php?offset=" + offset + "&livegroup=" + livegroup;
    ...
    HttPRequest.onreadystatechange = function() {
        if (HttPRequest.readyState == 3) {
            document.getElementById("livechannel").innerHTML = "Loading...";
        }
        if (HttPRequest.readyState == 4) {
            document.getElementById("livechannel").innerHTML = HttPRequest.responseText;
        }
    }
}

function ajaxcallgetapk(l) {
    var url = "action-getapk.php?l=" + l;
    var HttPRequest = Call_Inint_AJAX();
    if (!HttPRequest) {
        alert('Cannot create XMLHTTP instance');
        return false;
    ...
    HttPRequest.onreadystatechange = function() {
        ...
        if (HttPRequest.readyState == 4) {
            document.getElementById("").innerHTML = HttPRequest.responseText;
        }
    }
}

function ajaxippbliveplayer(id) {
    var url = "action-ippbliveplayer.php?id=" + id;
    var HttPRequest = Call_Inint_AJAX();
    if (!HttPRequest) {
        alert('Cannot create XMLHTTP instance');
        return false;
    ...
    HttPRequest.onreadystatechange = function() {
        if (HttPRequest.readyState == 3) {
            document.getElementById("ippbliveplayer").innerHTML = "Loading...";
        }
        if (HttPRequest.readyState == 4) {
            document.getElementById("ippbliveplayer").innerHTML = HttPRequest.responseText;
        }
    }
}

function ajaxippbliveplayer_x(id) {
    var url = "action-ippbliveplayer.php?id=" + id;
    var HttPRequest = Call_Inint_AJAX();
    if (!HttPRequest) {
        alert('Cannot create XMLHTTP instance');
    ...
    HttPRequest.onreadystatechange = function() {
        if (HttPRequest.readyState == 3) {
            document.getElementById("ippbliveplayermobile").innerHTML = "Loading...";
        }
        if (HttPRequest.readyState == 4) {
            document.getElementById("ippbliveplayermobile").innerHTML = HttPRequest.responseText;
        }
    }
}

function ajaxippbliveplayermobile(id) {
    var url = "action-ippbliveplayer-mobile.php?id=" + id;
    var HttPRequest = Call_Inint_AJAX();
    if (!HttPRequest) {
        alert('Cannot create XMLHTTP instance');
        return false;
...
function ajax_ippb_checkusername(username) {
    var url = "action-checkusername.php";
    var ippb_element = "username_chk";
    ...
    HttPRequest.onreadystatechange = function() {
        if (HttPRequest.readyState == 4) {
            document.getElementById(ippb_element).innerHTML = HttPRequest.responseText;
        }
    }
}

function ajaxippbliveplayersmarttv(id) {
    window.location.href = "action-ippbliveplayer-smarttv.php?id=" + id;
}

function ajaxippblivegroup(livegroup) {
    var url = "action-ippblivegroup.php?livegroup=" + livegroup;
    var HttPRequest = Call_Inint_AJAX();
    if (!HttPRequest) {
        alert('Cannot create XMLHTTP instance');
        return false;
    ...
    HttPRequest.onreadystatechange = function() {
        if (HttPRequest.readyState == 3) {
            document.getElementById("ippblivegroup").innerHTML = "Loading...";
        }
        if (HttPRequest.readyState == 4) {
            document.getElementById("ippblivegroup").innerHTML = HttPRequest.responseText;
        }
    }
}
...
function ippb_topup() {
    ...
    if (card_code == "") {
        alert('à¸£à¸«à¸±à¸ªà¸šà¸±à¸•à¸£ (PIN Code) à¹„à¸¡à¹ˆà¸–à¸¹à¸à¸•à¹‰à¸­à¸‡ à¸à¸£à¸¸à¸“à¸²à¸¥à¸­à¸‡à¹ƒà¸«à¸¡à¹ˆà¸­à¸µà¸à¸„à¸£à¸±à¹‰à¸‡ \nà¸«à¸¡à¸²à¸¢à¹€à¸«à¸•à¸¸ : à¸£à¸«à¸±à¸ªà¸šà¸±à¸•à¸£ à¸¡à¸µà¸ˆà¸³à¸™à¸§à¸™ 12 à¸«à¸¥à¸±à¸');
    } else if (card_code.charAt(0) != 's' && card_code.charAt(0) != 'g' && card_code.charAt(0) != 'w') {
        alert('à¸£à¸«à¸±à¸ªà¸šà¸±à¸•à¸£ (PIN Code) à¹„à¸¡à¹ˆà¸–à¸¹à¸à¸•à¹‰à¸­à¸‡ à¸à¸£à¸¸à¸“à¸²à¸¥à¸­à¸‡à¹ƒà¸«à¸¡à¹ˆà¸­à¸µà¸à¸„à¸£à¸±à¹‰à¸‡ \nà¸«à¸¡à¸²à¸¢à¹€à¸«à¸•à¸¸ : à¸£à¸«à¸±à¸ªà¸šà¸±à¸•à¸£ à¸•à¹‰à¸­à¸‡à¸‚à¸¶à¹‰à¸™à¸•à¹‰à¸™à¸”à¹‰à¸§à¸¢ s à¸«à¸£à¸·à¸­ g à¹€à¸—à¹ˆà¸²à¸™à¸±à¹‰à¸™');
    } else if (card_code.length != 12) {
        alert('à¸£à¸«à¸±à¸ªà¸šà¸±à¸•à¸£ (PIN Code) à¹„à¸¡à¹ˆà¸–à¸¹à¸à¸•à¹‰à¸­à¸‡ à¸à¸£à¸¸à¸“à¸²à¸¥à¸­à¸‡à¹ƒà¸«à¸¡à¹ˆà¸­à¸µà¸à¸„à¸£à¸±à¹‰à¸‡ \nà¸«à¸¡à¸²à¸¢à¹€à¸«à¸•à¸¸ : à¸£à¸«à¸±à¸ªà¸šà¸±à¸•à¸£ à¸¡à¸µà¸ˆà¸³à¸™à¸§à¸™ 12 à¸«à¸¥à¸±à¸');
    } else {
        document.ippb_toppup_bycard.submit();
    }
}

function ippb_topup_front() {
    card_code = document.getElementById("card_code").value;
    if (card_code == "") {
        alert('à¸£à¸«à¸±à¸ªà¸šà¸±à¸•à¸£ (PIN Code) à¹„à¸¡à¹ˆà¸–à¸¹à¸à¸•à¹‰à¸­à¸‡ à¸à¸£à¸¸à¸“à¸²à¸¥à¸­à¸‡à¹ƒà¸«à¸¡à¹ˆà¸­à¸µà¸à¸„à¸£à¸±à¹‰à¸‡ \nà¸«à¸¡à¸²à¸¢à¹€à¸«à¸•à¸¸ : à¸£à¸«à¸±à¸ªà¸šà¸±à¸•à¸£ à¸¡à¸µà¸ˆà¸³à¸™à¸§à¸™ 12 à¸«à¸¥à¸±à¸');
    } else if (card_code.charAt(0) != 's' && card_code.charAt(0) != 'g' && card_code.charAt(0) != 'w') {
...
function changeType() {
    if (document.authen.password.type == 'password') {
        document.authen.password.type = 'text';
        document.authen.showpassword.checked = 'checked';
    } else {
        document.authen.password.type = 'password';
        document.authen.showpassword.checked = '';
    }
}

function onpressenterlogin(e, frm) {
    var key;
    if (window.event) {
    ...
    q.prototype = {
        ...
        _n2: function(b) {
            if (this._k2) {
                ...
                } else d = 0, 2 >= b ? (e = 3.5 * this._x, d = 0) : 2 < b && 3 >= b ? (e = 4 * this._x, d = 200) : 3 < b && (d = 300, 4 < b && (b = 4, d = 400, e = 6 * this._x), e = 5 * this._x), a = 2 * b * b / (2 * e) * (0 > a ? -1 : 1), e = 2 * b / e + d, 0 < this.endPos + a ? 0 < this.endPos ? this.animateTo(0, 800, "easeOutCubic") : this.animateTo(this.carouselWidth / 10 * ((d + 200) / 1E3), 1.1 * Math.abs(this.endPos) / b, "easeOutSine", !0, 0, 400, "easeOutCubic") : this.endPos + a < this.carouselWidth - this._h1 ? this.endPos < this.carouselWidth - this._h1 ? this.animateTo(this.carouselWidth - this._h1, 800, "easeOutCubic") : this.animateTo(this.carouselWidth - this._h1 - this.carouselWidth / 10 * ((d + 200) / 1E3), 1.1 * Math.abs(this.carouselWidth -
